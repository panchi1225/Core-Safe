...
const sanitizeReportData = (data: any): NewcomerSurveyReportData => {
  ...
  if (data) {
    ...
    // 修正: Firebase保存エラー回避のため、undefined ではなく null を使用
    base = {
      ...base,
